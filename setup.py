...
setup(
  name = 'geoshape',         # How you named your package folder (MyLib)
  packages = ['geoshape'],   # Chose the same as "name"
  ...
  url = 'https://github.com/abiraihan/geoshape',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/abiraihan/geodesigns/archive/v0.1.tar.gz',    # I explain this later on
